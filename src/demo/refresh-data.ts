...
import { existingAvds, listAndroidAvds, runningAndroidAvdNames } from "../android/avds.js";
import { specSupportedByDevice, loadDeviceSoftware } from "../android/device-xml.js";
import {
...
} from "../android/profiles.js";
import { resolveAvdmanager, resolveSdkRoot, resolveSdkmanager } from "../android/sdk.js";
import {
  specFromImage,
  specFromSysdir,
  specKey,
  uniqueSpecs,
  type ImageSpec,
} from "../android/specs.js";
import { CREATE_VALUE } from "../constants.js";
import { runFile } from "../host/exec.js";
import { appleRuntimeFromKey } from "../ios/runtime.js";
import { listIosSimulators, listWatchSimulators } from "../ios/simulators.js";
import type { ExecOutputError, FormFactor, MenuItem } from "../types.js";
import type { DemoAvd, DemoIosDevice, DemoProfile, DemoWorld } from "./data.js";
...
function main(): void {
  ...
  const dataPath = path.join(repoRoot, "src", "demo", "data.ts");
