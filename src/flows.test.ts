...
import { BACK, CLOSE_SUSPEND, CLOSE_TERMINATE, ORANGE, RESET, SIMULATE_NOTE } from "./constants.js";
import { closeRequest } from "./devices/close.js";
import { closedMessage, main, startedMessage } from "./flows.js";
